import { c as createLucideIcon, ag as commonjsGlobal, ah as getDefaultExportFromCjs, r as reactExports, ai as clsx, aj as React, ak as invariant, a as useBills, b as usePayments, k as useStudents, f as useClasses, j as jsxRuntimeExports, l as Button, al as ChartNoAxesColumn, F as FileText, B as Badge, e as BillStatus, U as Users, am as PaymentMethod } from "./index-BCwf3qRa.js";
import { P as PageHeader } from "./PageHeader-BUSvgm_1.js";
import { T as TrendingUp, S as StatsCard } from "./StatsCard-BwkdajfT.js";
...
const fmt = (n2) => `₹${Number(n2).toLocaleString("en-IN", { maximumFractionDigits: 0 })}`;
function toDateStr(ts) {
  return new Date(Number(ts) / 1e6).toISOString().slice(0, 10);
}
function daysOverdue(dueTs) {
  const diff = Date.now() - Number(dueTs) / 1e6;
  return Math.max(0, Math.floor(diff / 864e5));
}
function downloadCSV(filename, rows) {
  const content = rows.map((r) => r.map((c2) => `"${c2.replace(/"/g, '""')}"`).join(",")).join("\n");
...
function ReportSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: Array.from({ length: 3 }, (_, i) => `skel-report-${i}`).map((k2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-28 rounded-xl" }, k2)) }),
...
function DailyTab({
  ...
  const [date2, setDate] = reactExports.useState(today);
  const studentMap = reactExports.useMemo(() => {
    const m2 = /* @__PURE__ */ new Map();
    for (const s2 of students) m2.set(s2.id, s2);
    return m2;
  }, [students]);
  const filtered = reactExports.useMemo(
    () => payments.filter((p2) => toDateStr(p2.paymentDate) === date2),
    [payments, date2]
  );
  const totalCollected = reactExports.useMemo(
    () => filtered.reduce((acc, p2) => acc + p2.amount, 0n),
    [filtered]
  );
  const methodBreakdown = reactExports.useMemo(() => {
    const acc = {};
    for (const p2 of filtered) {
      acc[p2.method] = (acc[p2.method] ?? 0) + Number(p2.amount);
    }
  ...
  function exportCSV() {
    const rows = [
      ...
      ...filtered.map((p2) => {
        ...
        return [
          p2.id.toString(),
          ((_a = studentMap.get(p2.studentId)) == null ? void 0 : _a.name) ?? "Unknown",
          Number(p2.amount).toString(),
          p2.method,
          toDateStr(p2.paymentDate),
          p2.referenceNumber
        ];
      })
    ];
    downloadCSV(`daily-report-${date2}.csv`, rows);
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "daily_report.section", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "glass border-border/50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-semibold", children: "Payment Method Breakdown" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: methodBreakdown.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Pie,
            {
              ...
              children: methodBreakdown.map((entry, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Cell,
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Tooltip,
            {
              formatter: (v2) => `₹${v2.toLocaleString("en-IN")}`
            }
          )
        ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-[220px] text-muted-foreground text-sm", children: "No transactions for this date" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "glass border-border/50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-semibold", children: "Transactions" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-auto max-h-[260px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "sticky top-0 bg-card/90 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/50", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-2 text-muted-foreground font-medium", children: "Student" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-4 py-2 text-muted-foreground font-medium", children: "Amount" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-2 text-muted-foreground font-medium", children: "Method" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "tr",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5 truncate max-w-[120px]", children: ((_a = studentMap.get(p2.studentId)) == null ? void 0 : _a.name) ?? "—" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5 text-right font-mono tabular-nums text-emerald-400", children: fmt(p2.amount) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-xs", children: p2.method }) })
                ]
              },
              p2.id.toString()
            );
...
function MonthlyTab({
  ...
  reactExports.useMemo(() => {
    const m2 = /* @__PURE__ */ new Map();
    for (const c2 of classes) m2.set(c2.id, c2);
    return m2;
  }, [classes]);
  const pad2 = reactExports.useCallback((n2) => String(n2).padStart(2, "0"), []);
  const monthStr = `${year}-${pad2(month)}`;
  const prevMonth = month === 1 ? `${year - 1}-12` : `${year}-${pad2(month - 1)}`;
  const monthPayments = reactExports.useMemo(
    () => payments.filter((p2) => toDateStr(p2.paymentDate).startsWith(monthStr)),
    [payments, monthStr]
  );
  const prevPayments = reactExports.useMemo(
    () => payments.filter((p2) => toDateStr(p2.paymentDate).startsWith(prevMonth)),
    [payments, prevMonth]
  );
  const totalCurrent = monthPayments.reduce((a2, p2) => a2 + p2.amount, 0n);
  const totalPrev = prevPayments.reduce((a2, p2) => a2 + p2.amount, 0n);
  const trendPct = totalPrev === 0n ? 0 : Math.round(
    (Number(totalCurrent) - Number(totalPrev)) / Number(totalPrev) * 100
  );
  const daysInMonth = new Date(year, month, 0).getDate();
  const dailyData = reactExports.useMemo(() => {
    const acc = {};
    for (const p2 of monthPayments) {
      const d2 = toDateStr(p2.paymentDate);
      acc[d2] = (acc[d2] ?? 0) + Number(p2.amount);
    }
    return Array.from({ length: daysInMonth }, (_, i) => {
      const day = `${monthStr}-${pad2(i + 1)}`;
      return { day: i + 1, amount: acc[day] ?? 0 };
    });
  }, [monthPayments, monthStr, daysInMonth, pad2]);
  const classData = reactExports.useMemo(() => {
    const acc = {};
    for (const p2 of monthPayments) {
      const cls = "All Classes";
      acc[cls] = (acc[cls] ?? 0) + Number(p2.amount);
    }
    return Object.entries(acc).map(([name, value]) => ({ name, value }));
  }, [monthPayments]);
  function exportCSV() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "monthly_report.section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Select,
          {
            value: String(month),
            onValueChange: (v2) => setMonth(Number(v2)),
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                SelectTrigger,
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: MONTHS.map((m2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: String(i + 1), children: m2 }, m2)) })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          {
            value: String(year),
            onValueChange: (v2) => setYear(Number(v2)),
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                SelectTrigger,
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: years.map((y2) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: String(y2), children: y2 }, y2)) })
            ]
          }
        )
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-4", children: [
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                YAxis,
                {
                  ...
                  width: 60,
                  tickFormatter: (v2) => v2 >= 1e3 ? `${Math.round(v2 / 1e3)}k` : String(v2)
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Tooltip,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "glass border-border/50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-semibold", children: "Collection Overview" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          BarChart,
          {
            data: classData,
...
function PendingTab({
  ...
  const pending = reactExports.useMemo(
    () => bills.filter(
      (b2) => (b2.status === BillStatus.Pending || b2.status === BillStatus.Overdue || b2.status === BillStatus.Partial_) && (classFilter === "all" || b2.classId.toString() === classFilter)
    ).sort((a2, b2) => daysOverdue(b2.dueDate) - daysOverdue(a2.dueDate)),
    [bills, classFilter]
  );
  const totalPending = pending.reduce((a2, b2) => a2 + b2.netAmount, 0n);
  const uniqueStudents = new Set(pending.map((b2) => b2.studentId.toString())).size;
  function exportCSV() {
    const rows = [
      [
        "Bill#",
      ...
      ...pending.map((b2) => {
        ...
        return [
          b2.billNumber,
          ((_a = studentMap.get(b2.studentId)) == null ? void 0 : _a.name) ?? "Unknown",
          ((_b = classMap.get(b2.classId)) == null ? void 0 : _b.name) ?? "—",
          Number(b2.netAmount).toString(),
          toDateStr(b2.dueDate),
          daysOverdue(b2.dueDate).toString(),
          b2.status
        ];
      })
    ];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "pending_fees.section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: classFilter, onValueChange: setClassFilter, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          SelectTrigger,
          {
            className: "w-44",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
          ...
          classes.map((c2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectItem, { value: c2.id.toString(), children: [
            c2.name,
            " — ",
            c2.section
          ] }, c2.id.toString()))
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "glass border-border/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "sticky top-0 bg-card/90 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: "Student" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: "Class" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: "Bill #" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-4 py-3 text-muted-foreground font-medium", children: "Amount" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: "Due Date" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-4 py-3 text-muted-foreground font-medium", children: "Overdue" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: pending.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "td",
        {
          ...
          children: "No pending fees found 🎉"
        }
      ) }) : pending.map((b2, i) => {
        var _a, _b;
        const over = daysOverdue(b2.dueDate);
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            className: "border-b border-border/30 hover:bg-muted/30",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-medium truncate max-w-[140px]", children: ((_a = studentMap.get(b2.studentId)) == null ? void 0 : _a.name) ?? "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground", children: ((_b = classMap.get(b2.classId)) == null ? void 0 : _b.name) ?? "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-mono text-xs text-muted-foreground", children: b2.billNumber }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-right font-mono tabular-nums", children: fmt(b2.netAmount) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground", children: toDateStr(b2.dueDate) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-right", children: over > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-red-400 font-semibold", children: [
                over,
                "d"
              ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-emerald-400", children: "—" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { status: b2.status, size: "sm" }) })
            ]
          },
          b2.id.toString()
        );
...
function DefaultersTab({
  ...
  const defaulterRows = reactExports.useMemo(() => {
    var _a;
    const byStudent = /* @__PURE__ */ new Map();
    for (const b2 of bills) {
      if (b2.status !== BillStatus.Overdue) continue;
      const key = b2.studentId.toString();
      const stu = studentMap.get(b2.studentId);
      if (!stu) continue;
      if (byStudent.has(key)) {
        const r = byStudent.get(key);
        r.outstanding += b2.netAmount;
        if (b2.dueDate < r.oldestDue) r.oldestDue = b2.dueDate;
      } else {
        byStudent.set(key, {
          student: stu,
          outstanding: b2.netAmount,
          oldestDue: b2.dueDate,
          cls: ((_a = classMap.get(b2.classId)) == null ? void 0 : _a.name) ?? "—"
        });
      }
    }
    return Array.from(byStudent.values()).sort(
      (a2, b2) => Number(b2.outstanding - a2.outstanding)
    );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "defaulters.section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "glass border-border/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "sticky top-0 bg-card/90 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: "Student" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: "Admission #" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: "Class" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: "Parent Phone" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: "Parent Email" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-4 py-3 text-muted-foreground font-medium", children: "Outstanding" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: "Oldest Due" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: defaulterRows.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "td",
        {
          colSpan: 7,
          className: "text-center py-10 text-muted-foreground",
          "data-ocid": "defaulters.empty_state",
          children: "No defaulters found 🎉"
        }
      ) }) : defaulterRows.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "tr",
        {
          className: "border-b border-border/30 hover:bg-muted/30",
          "data-ocid": `defaulters.item.${i + 1}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-medium", children: r.student.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-mono text-xs text-muted-foreground", children: r.student.admissionNumber }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground", children: r.cls }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: r.student.parentPhone }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 truncate max-w-[160px] text-muted-foreground", children: r.student.parentEmail }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-right font-mono tabular-nums text-red-400 font-semibold", children: fmt(r.outstanding) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground", children: toDateStr(r.oldestDue) })
          ]
        },
...
function ClasswiseTab({
  ...
  const academicYears = reactExports.useMemo(() => {
    const s2 = new Set(bills.map((b2) => b2.academicYear));
    return Array.from(s2).sort().reverse();
  }, [bills]);
  const [ayFilter, setAyFilter] = reactExports.useState("all");
  const classMap = reactExports.useMemo(() => {
    const m2 = /* @__PURE__ */ new Map();
    for (const c2 of classes) m2.set(c2.id, c2);
    return m2;
  ...
  const filteredBills = reactExports.useMemo(
    () => ayFilter === "all" ? bills : bills.filter((b2) => b2.academicYear === ayFilter),
    [bills, ayFilter]
  );
  const classStats = reactExports.useMemo(() => {
    const acc = /* @__PURE__ */ new Map();
    for (const b2 of filteredBills) {
      const key = b2.classId.toString();
      const cls = classMap.get(b2.classId);
      const name = cls ? `${cls.name} ${cls.section}` : `Class ${key}`;
      if (!acc.has(key))
        acc.set(key, { classId: b2.classId, name, billed: 0n, collected: 0n });
      const r = acc.get(key);
      r.billed += b2.totalAmount;
      if (b2.status === BillStatus.Paid) r.collected += b2.totalAmount;
      else if (b2.status === BillStatus.Partial_)
        r.collected += b2.totalAmount - b2.netAmount;
    }
  ...
  function exportCSV() {
    const rows = [
      ...
      ...classStats.map((r) => [
        ...
        r.billed > 0n ? `${Math.round(Number(r.collected) / Number(r.billed) * 100)}%` : "0%"
      ])
    ];
    downloadCSV(`classwise-${ayFilter}.csv`, rows);
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "classwise.section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: ayFilter, onValueChange: setAyFilter, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "w-44", "data-ocid": "classwise.year_filter", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "All Academic Years" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", children: "All Years" }),
          academicYears.map((ay) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: ay, children: ay }, ay))
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "glass border-border/50", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-semibold", children: "Collection per Class" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: chartData.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        BarChart,
        {
          data: chartData,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "glass border-border/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "sticky top-0 bg-card/90 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: "Class" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-4 py-3 text-muted-foreground font-medium", children: "Total Billed" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-4 py-3 text-muted-foreground font-medium", children: "Collected" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-4 py-3 text-muted-foreground font-medium", children: "Pending" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-4 py-3 text-muted-foreground font-medium", children: "Rate %" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: classStats.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "td",
        {
          colSpan: 5,
          className: "text-center py-10 text-muted-foreground",
          children: "No class data available"
        }
      ) }) : classStats.map((r, i) => {
        const rate = r.billed > 0n ? Math.round(
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-right font-mono tabular-nums", children: fmt(r.billed) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-right font-mono tabular-nums text-emerald-400", children: fmt(r.collected) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-right font-mono tabular-nums text-amber-400", children: fmt(r.billed - r.collected) }),
...
function TransactionTab({
  ...
  const filtered = reactExports.useMemo(
    () => payments.filter((p2) => {
      const d2 = toDateStr(p2.paymentDate);
      if (dateFrom && d2 < dateFrom) return false;
      if (dateTo && d2 > dateTo) return false;
      if (methodFilter !== "all" && p2.method !== methodFilter) return false;
      return true;
    }),
    [payments, dateFrom, dateTo, methodFilter]
  );
  const totalAmount = filtered.reduce((a2, p2) => a2 + p2.amount, 0n);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "transaction_report.section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs text-muted-foreground", htmlFor: "txn-from", children: "From" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            id: "txn-from",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs text-muted-foreground", htmlFor: "txn-to", children: "To" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            id: "txn-to",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: methodFilter, onValueChange: setMethodFilter, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
          ...
          methods.map((m2) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: m2, children: m2 }, m2))
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "glass border-border/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "sticky top-0 bg-card/90 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: "Payment ID" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: "Student" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-4 py-3 text-muted-foreground font-medium", children: "Amount" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: "Method" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: "Date" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-muted-foreground font-medium", children: "Reference" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "td",
        {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5 font-medium", children: ((_a = studentMap.get(p2.studentId)) == null ? void 0 : _a.name) ?? "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5 text-right font-mono tabular-nums text-emerald-400", children: fmt(p2.amount) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-xs", children: p2.method }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5 text-muted-foreground", children: toDateStr(p2.paymentDate) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5 text-muted-foreground font-mono text-xs truncate max-w-[120px]", children: p2.referenceNumber || "—" })
            ]
          },
          p2.id.toString()
        );
      }) }),
      filtered.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("tfoot", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-t-2 border-border bg-muted/30", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 2, className: "px-4 py-3 font-semibold", children: "Total" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-right font-mono tabular-nums font-bold text-emerald-400", children: fmt(totalAmount) }),
...
function ReportsPage() {
  ...
  const isLoading = billsLoading || paymentsLoading || studentsLoading || classesLoading;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 print:space-y-4", "data-ocid": "reports.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      PageHeader,
      {
    ...
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(ReportSkeleton, {}) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "daily", className: "w-full", "data-ocid": "reports.tabs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "flex flex-wrap h-auto gap-1 bg-muted/50 p-1 mb-6 print:hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "daily", "data-ocid": "reports.tab.daily", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-3.5 w-3.5 mr-1.5" }),
          "Daily"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "monthly", "data-ocid": "reports.tab.monthly", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-3.5 w-3.5 mr-1.5" }),
          "Monthly"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "pending", "data-ocid": "reports.tab.pending", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Wallet, { className: "h-3.5 w-3.5 mr-1.5" }),
          "Pending Fees"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "defaulters", "data-ocid": "reports.tab.defaulters", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-3.5 w-3.5 mr-1.5" }),
          "Defaulters"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "classwise", "data-ocid": "reports.tab.classwise", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { className: "h-3.5 w-3.5 mr-1.5" }),
          "Class-wise"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          TabsTrigger,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "daily", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        DailyTab,
        {
          payments,
          students
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "monthly", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        MonthlyTab,
        {
          payments,
          classes
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "defaulters", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        DefaultersTab,
        {
          bills,
          students,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "classwise", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        ClasswiseTab,
        {
          bills,
          payments,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "transactions", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        TransactionTab,
        {
          payments,
          students,
